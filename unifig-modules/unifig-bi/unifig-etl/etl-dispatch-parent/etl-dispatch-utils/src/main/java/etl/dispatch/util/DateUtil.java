...
public class DateUtil extends DateUtils {
    ...
    public static int getIntMonth(Date date) {
        ...
        if(month.startsWith("0")){
        	return NumberUtils.intValue(month.substring(1));
        }
        return NumberUtils.intValue(month);
    }
    ...
    public static int getIntDay(Date date) {
        ...
        if(day.startsWith("0")){
        	return NumberUtils.intValue(day.substring(1));
        }
        return NumberUtils.intValue(day);
    }
    ...
    public static String getHour(Date date) {
        ...
        SimpleDateFormat yearFormat = new SimpleDateFormat("HH");
        return yearFormat.format(date);
    }
