 ...
 */
@Service
public class OperationCount extends AbstractScript implements ScheduledService {

	private static Logger logger = LoggerFactory.getLogger(OperationCount.class);
	private static final String configJsonPath = "classpath*:conf/spapjson/operation_count.json";
	...
	protected void start(ScriptBean scriptBean, ScriptCallBack callback) {
		...
		try {
			...
			// 创建目标表
			String create_operaton_count_ds_log = super.getJsonConfigValue(configJsonPath, "create_operaton_count_ds_log");
			if (!StringUtil.isNullOrEmpty(create_operaton_count_ds_log)) {
				SqlUtils.sqlExecute(target, create_operaton_count_ds_log, this.getName());
			}
			...
			// 2:拉取数据
			this.sqlInsert = super.getJsonConfigValue(configJsonPath, "insert_operaton_count_log");
					...
					try {
						...
						for (Map<Object, Object> log : shardingFlushEntries) {
							try {
								...
								pstmt.setLong(3, NumberUtils.longValue(log.get("start_num1")));
								pstmt.setLong(4, NumberUtils.longValue(log.get("start_num2")));
								pstmt.setLong(5, NumberUtils.longValue(log.get("start_num3")));
								pstmt.setLong(6, NumberUtils.longValue(log.get("start_num4")));
								pstmt.setLong(7, NumberUtils.longValue(log.get("start_num5")));
								pstmt.setLong(8, NumberUtils.longValue(log.get("start_num6")));
								pstmt.setLong(9, NumberUtils.longValue(log.get("start_num7")));
								pstmt.setLong(10, NumberUtils.longValue(log.get("start_num8")));
								pstmt.setLong(11, NumberUtils.longValue(log.get("start_num9")));
								pstmt.setLong(12, NumberUtils.longValue(log.get("start_num10")));
								pstmt.setLong(13, NumberUtils.longValue(log.get("start_num11")));
								pstmt.setLong(14, NumberUtils.longValue(log.get("start_num12")));
								pstmt.setLong(15, NumberUtils.longValue(log.get("start_num13")));
								pstmt.setLong(16, NumberUtils.longValue(log.get("start_num14")));
								pstmt.setLong(17, NumberUtils.longValue(log.get("start_num15")));
								pstmt.setLong(18, NumberUtils.longValue(log.get("start_num16")));
								pstmt.setLong(19, NumberUtils.longValue(log.get("start_num17")));
								pstmt.setLong(20, NumberUtils.longValue(log.get("start_num18")));
								pstmt.setLong(21, NumberUtils.longValue(log.get("start_num19")));
								pstmt.setLong(22, NumberUtils.longValue(log.get("start_num20")));
								pstmt.setLong(23, NumberUtils.longValue(log.get("start_num21")));
								pstmt.setLong(24, NumberUtils.longValue(log.get("start_num22")));
								pstmt.setLong(25, NumberUtils.longValue(log.get("start_num23")));
								pstmt.setLong(26, NumberUtils.longValue(log.get("start_num24")));
