...
@Service
public class Dwd_ApplicationLoginLog extends AbstractScript {
	private static Logger logger = LoggerFactory.getLogger(Dwd_ApplicationLoginLog.class);
	private static final String configJsonPath = "classpath*:conf/json/dwd_applicationLoginLog.json";
	...
	public String getName() {
		return "dwd.applicationloginlog";
	}
