...
import etl.dispatch.java.spap.ods.Ods_SpapLoginLog;
...
@Service
public class Dwd_operation_count extends AbstractScript implements ScheduledService {

	private static Logger logger = LoggerFactory.getLogger(Dwd_operation_count.class);
	private static final String configJsonPath = "classpath*:conf/spapjson/Dwd_operation_count.json";
					...
					try {
						...
						for (Map<Object, Object> loginLog : shardingFlushEntries) {
							try {
								...
								pstmt.setString(33, String.valueOf(loginLog.get("app_version")));
