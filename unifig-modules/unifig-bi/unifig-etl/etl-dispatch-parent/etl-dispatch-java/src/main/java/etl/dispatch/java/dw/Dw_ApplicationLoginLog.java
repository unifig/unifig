 ...
 */
@Service
public class Dw_ApplicationLoginLog extends AbstractScript {
	private static Logger logger = LoggerFactory.getLogger(Dw_ApplicationLoginLog.class);
	private static final String configJsonPath = "classpath*:conf/json/dw_applicationLoginLog.json";
