...
@Service
public class Dwd_ApplicationUserInfo extends AbstractScript {
	private static Logger logger = LoggerFactory.getLogger(Dwd_ApplicationUserInfo.class);
	private static final String configJsonPath = "classpath*:conf/json/dwd_applicationUserInfo.json";
	...
	public String getName() {
		return "dwd.applicationuserinfo";
	}
