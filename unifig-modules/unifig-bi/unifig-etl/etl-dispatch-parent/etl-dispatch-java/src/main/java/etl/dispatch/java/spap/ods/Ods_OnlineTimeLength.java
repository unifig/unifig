...
@Service
public class Ods_OnlineTimeLength  extends AbstractScript implements ScheduledService {

	private static Logger logger = LoggerFactory.getLogger(Ods_Operation_counts.class);
	private static final String configJsonPath = "classpath*:conf/spapjson/ods_OnlineTimeLength.json";
	...
	private String sqlInsert ="INSERT INTO bi_ods_spap.ods_usage_time(`id` ,`uid` ,`time1`,`time2`,`time3`,`time4`,`time5`,`time6`,`time7`,`time8`,`time9`,`time10`,`time11`,`time12`,`time13`,`time14`,`time15`,`time16`,`time17`,`time18`,`time19`,`time20`,`time21`,`time22`,`time23`,`time24`,`create_time`,`app_plat_id`,`country_id`,`region_id`,`city_id`,channel,app_version_id,`year`,`month`,`day`,`hour`,`store_id`)VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	private String sqlInsertWithoutValues;
	private Optional<Integer> saveDays = Optional.empty();
	private String optime_month;
	public Ods_OnlineTimeLength() {
					...
					try {
						...
						for (Map<Object, Object> loginLog : shardingFlushEntries) {
							try {
								...
								pstmt.setLong(3, NumberUtils.longValue(loginLog.get("time1")));
								pstmt.setLong(4, NumberUtils.longValue(loginLog.get("time2")));
								pstmt.setLong(5, NumberUtils.longValue(loginLog.get("time3")));
								pstmt.setLong(6, NumberUtils.longValue(loginLog.get("time4")));
								pstmt.setLong(7, NumberUtils.longValue(loginLog.get("time5")));
								pstmt.setLong(8, NumberUtils.longValue(loginLog.get("time6")));
								pstmt.setLong(9, NumberUtils.longValue(loginLog.get("time7")));
								pstmt.setLong(10, NumberUtils.longValue(loginLog.get("time8")));
								pstmt.setLong(11, NumberUtils.longValue(loginLog.get("time9")));
								pstmt.setLong(12, NumberUtils.longValue(loginLog.get("time10")));
								pstmt.setLong(13, NumberUtils.longValue(loginLog.get("time11")));
								pstmt.setLong(14, NumberUtils.longValue(loginLog.get("time12")));
								pstmt.setLong(15, NumberUtils.longValue(loginLog.get("time13")));
								pstmt.setLong(16, NumberUtils.longValue(loginLog.get("time14")));
								pstmt.setLong(17, NumberUtils.longValue(loginLog.get("time15")));
								pstmt.setLong(18, NumberUtils.longValue(loginLog.get("time16")));
								pstmt.setLong(19, NumberUtils.longValue(loginLog.get("time17")));
								pstmt.setLong(20, NumberUtils.longValue(loginLog.get("time18")));
								pstmt.setLong(21, NumberUtils.longValue(loginLog.get("time19")));
								pstmt.setLong(22, NumberUtils.longValue(loginLog.get("time20")));
								pstmt.setLong(23, NumberUtils.longValue(loginLog.get("time21")));
								pstmt.setLong(24, NumberUtils.longValue(loginLog.get("time22")));
								pstmt.setLong(25, NumberUtils.longValue(loginLog.get("time23")));
								pstmt.setLong(26, NumberUtils.longValue(loginLog.get("time24")));
