 ...
 */
@Service
public class Dw_ApplicationUserInfo extends AbstractScript {
	private static Logger logger = LoggerFactory.getLogger(Dw_ApplicationUserInfo.class);
	private static final String configJsonPath = "classpath*:conf/json/dw_applicationUserInfo.json";
