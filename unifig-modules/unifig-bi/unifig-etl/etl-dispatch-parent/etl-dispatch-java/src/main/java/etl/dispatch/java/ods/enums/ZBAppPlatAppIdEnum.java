 ...
 * @author 、
 */
public enum ZBAppPlatAppIdEnum {
	web(21, 6), // web端所传参数
	...
	public static final Map<Integer, ZBAppPlatAppIdEnum> lookup = new LinkedHashMap<Integer, ZBAppPlatAppIdEnum>();
	static {
		for (ZBAppPlatAppIdEnum s : EnumSet.allOf(ZBAppPlatAppIdEnum.class)) {
			lookup.put(s.getAppPlatId(), s);
		}
	}

	ZBAppPlatAppIdEnum(int appPlatId, int appId) {
