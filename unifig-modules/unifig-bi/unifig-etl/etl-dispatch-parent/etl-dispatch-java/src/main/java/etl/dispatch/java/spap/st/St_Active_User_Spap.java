 ...
 */
@Service
public class St_Active_User_Spap extends AbstractScript {
	private static Logger logger = LoggerFactory.getLogger(St_Active_User_Spap.class);
	private static final String configJsonPath = "classpath*:conf/spapjson/st_active_user.json";
	private static final String select_source_storeId = "${store_id}";

	private DataSourcePool dataSourcePool;

	public String getName() {
		return "st.active_user_spap";
	}
