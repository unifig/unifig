...
import com.unifig.bi.analysis.model.StUmsRegister;
 ...
 * @since 2019-03-21
 */
public interface StUmsRegisterMapper extends BaseMapper<StUmsRegister> {

    Map<String, Object> countRegister(Map<String, Object> registerCountParemMap);
