...
import com.unifig.mall.mapper.SmsHomeAdvertiseMapper;
...
public class SmsHomeAdvertiseServiceImpl implements SmsHomeAdvertiseService {
    ...
    @Override
    public List<HomeSmsAdvertiseVo> selectHomeList() {
        List<HomeSmsAdvertiseVo> homeSmsAdvertiseVos = advertiseMapper.selectHomeList();
        return homeSmsAdvertiseVos;
    }

    @Override
    public List<HomeSmsAdvertiseVo> selectHomeListByType(java.sql.Date now, Integer type) {
        List<HomeSmsAdvertiseVo> homeSmsAdvertiseVos = advertiseMapper.selectHomeListByType(type,now);
         return homeSmsAdvertiseVos;
    }
}
