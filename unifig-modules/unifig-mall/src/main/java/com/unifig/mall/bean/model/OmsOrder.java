...
public class OmsOrder implements Serializable {
     ...
     * @mbggenerated
     */
    @ApiModelProperty("付方式：0->未支付；1->支付宝；2->微信")
     ...
     * @mbggenerated
     */
    @ApiModelProperty("订单状态：0->待付款；1->待发货；2->已发货；3->已完成；4 ->已关闭；5->无效订单  ; 6 -> 团购中 ;7 -> 申请退款;8-> 退款中;9 退款完成 ;10-> 拒绝退款 ")
     ...
     * @mbggenerated
     */
    @ApiModelProperty("订单类型：0->正常订单；1->秒杀订单  :2->团购订单")
