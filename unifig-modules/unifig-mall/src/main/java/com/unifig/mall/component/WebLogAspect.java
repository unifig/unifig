...
import com.unifig.mall.util.JsonUtil;
import com.unifig.mall.util.RequestUtil;
import com.unifig.mall.bean.bo.WebLog;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.unifig.mall.controller.*.*(..))")
    public void webLog() {
    }
