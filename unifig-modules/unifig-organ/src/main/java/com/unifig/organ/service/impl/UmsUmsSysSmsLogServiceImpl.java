...
import com.unifig.organ.dao.UmsSysSmsLogDao;
...
import com.unifig.utils.IdUtil;
...
public class UmsUmsSysSmsLogServiceImpl implements UmsSysSmsLogService {
    @Autowired
    private UmsSysSmsLogDao smsLogDao;
    @Autowired
...
//        }
        try {
             ...
             */
            // QCloudSMSUtil.sendSMS( smsLog.getMobile(),smsLog.getContent());
