 ...
 * @date 2018-10-24
 */
public class BeanMapUtils extends PropertyUtilsBean {
     ...
     *            要构造新的实例对象Class
     */
    public static <T> T copyJavaBean(Object source, Class<T> destinationClass) {
        if (source != null) {
     ...
     * @return
     */
    public static <T> List<T> copyListJavaBean(Collection sourceList, Class<T> destinationClass) {
     ...
     */
    public static void copyJavaBean(Object source, Object destinationObject) {
